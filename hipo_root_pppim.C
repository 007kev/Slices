...
void hipo_root_pppim()
{
    ...
    chain.Add("/lustre24/expphy/volatile/clas12/leomart/Data/Runs/Spring2019/FT/006616/rec_clas_006616.evio.*.hipo");
    ...
    TFile *file       = new TFile("kev_Pppim_eFD_006616.root", "RECREATE");
